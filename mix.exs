defmodule Bonfire.Device.MixProject do
  use Mix.Project

  @app :bonfire_device
  @version "0.1.0"
  @wifi_AP_targets [:rpi, :rpi0, :rpi2, :rpi3, :rpi3a, :rpi4, :bbb, :osd32mp1, :x86_64]
  @all_targets @wifi_AP_targets ++ [:grisp2]
  ...
  def application do
    [
      mod: {Bonfire.Device.Application, []},
  ...
  defp deps do
    [
      ...
      # Extra targets
      {:nerves_system_grisp2, "~> 0.2.3", runtime: false, targets: :grisp2},

      # WiFi config
      {:vintage_net_wizard, "~> 0.4.7", targets: @wifi_AP_targets},
